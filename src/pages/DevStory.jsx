      ...
      <Layout>
        ...
        <div className="dev-story desc-box shadow-scrollwindow">
          ...
          <p>
            ...
            as classic asp). Since I was the guy all the teachers called when
            they were having excel problems, I thought hey, why don't I build
            them a website to record their attendance rather than dealing with
            these clumsy spreadsheets?
          </p>
          <p>
          ...
          <p>
            ...
            pretty sweet student tracking machine that offered real-time metrics
            thanks to centralized data.
          </p>
          <p>
            COMAS did everything from tracking student hours and recording entry
            and exit dates, to genereating standardized reports. They liked it
            so much they used it for over 8 years; and I was hooked.
          </p>
          <hr />
          <span className="time-frame">
            <FontAwesomeIcon icon={faCalendar} />
          ...
          <p>
            ...
            newer technology. I soon acquired everything I would need to develop
            with asp.net web forms, and over the next couple years I designed
            multiple sites using the technology.
          </p>
          <p>
          ...
          <p>
            ...
            over the weekend, maybe there's someone out there with a sports car
            who needs a truck to help move over the weekend!
          </p>
          <p className="no-indent">
            <label
              onKeyDown={() => this.imgToggle(0)}
          ...
          <p>
            ...
            the world of finance, wrote a book on credit repair. He asked me if
            I'd be willing to develop a website that promotes his book and his
            brand. And so I built CreditScoreMaestro.com.
          </p>
          <p className="no-indent">
            <label
              onKeyDown={() => this.imgToggle(0)}
              ...
              className="btn-story-img"
            >
              {this.state.imgState[2].visible ? "Hide" : "Show"} Image of Credit
              Score Maestro!
            </label>
          ...
          <p>
            ...
            NextJs. I redesigned Credit Score Maetro using the Gatsby framework,
          ...
          <p>
            ...
            <em>Unsung Hero</em> gold badge on StackOverflow. I'm quite proud of
            this badge, as I pride myself on the enjoyment I find in helping
            others.
          </p>
        </div>
      </Layout>
